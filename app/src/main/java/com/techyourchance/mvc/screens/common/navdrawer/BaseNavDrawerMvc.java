...
public abstract class BaseNavDrawerMvc<ListenerType> extends BaseObservableViewMvc<ListenerType> {

    private final DrawerLayout mDrawerLayout;
    private final FrameLayout mFrameLayout;
    private final NavigationView mNavigationView;

    public BaseNavDrawerMvc(LayoutInflater inflater, @Nullable ViewGroup parent) {
